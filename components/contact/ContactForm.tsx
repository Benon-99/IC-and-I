      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="name" className="text-[#002060]/70">
              Name
            </label>
          </div>
          <input
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="email" className="text-[#002060]/70">
              Email
            </label>
          </div>
          <input
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="subject" className="text-[#002060]/70">
              Subject
            </label>
          </div>
          <input
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <MessageSquare className="w-5 h-5 text-[#002060]/70" />
            <label htmlFor="message" className="text-[#002060]/70">
              Message
            </label>
          </div>
          <textarea
